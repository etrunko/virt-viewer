...
static void
remote_viewer_iso_list_dialog_get_property(GObject *object, guint property_id,
                                           GValue *value, GParamSpec *pspec)
{
    ...
    case PROP_FOREIGN_MENU:
        g_value_set_object(value, priv->foreign_menu);
        break;
    default:
...
remote_viewer_iso_list_dialog_class_init(RemoteViewerISOListDialogClass *klass)
{
    ...
    object_class->get_property = remote_viewer_iso_list_dialog_get_property;
